...
const CreateRide = () => {
  ...
  return (
    <div className="min-h-screen pb-16 ">
      <PageHeader title="Create New Ride" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Select
                ...
                required
                options={[
                  { value: "Hinayay", label: "Hinayay - Chill lang" },
                  {
                    value: "Linaspagay",
                    label: "Linaspagay - Sunogay og Baga",
                  },
                ]}
                icon={
                  <svg
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-gray-900 mb-3 text-lg">
                Tips for Creating a Great Ride
              </h3>
              <ul className="space-y-2 text-sm text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span>Provide accurate meetup location and time</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span>Include route details and difficulty level</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span>Add GPX file if available for easy navigation</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span>
                    Mention any special requirements or equipment needed
                  </span>
                </li>
              </ul>
            </div>
